...
const styles = StyleSheet.create({
  ...
  header: { 
    ...
    backgroundColor: theme.colors.surface, borderBottomWidth: 4, borderColor: theme.colors.borderSubtle, 
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', zIndex: 50 
  },
  closeBtn: { width: 40, height: 40, borderRadius: 20, backgroundColor: theme.colors.surfaceMuted, alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderBottomWidth: 4, borderColor: theme.colors.borderSubtle },
  headerTitle: { fontFamily: 'Unbounded_600SemiBold', fontSize: 20, color: theme.colors.onSurface },
  headerSub: { fontFamily: 'JetBrainsMono_500Medium', fontSize: 12, color: theme.colors.onSurfaceVariant, marginTop: 4, letterSpacing: 1.5 },
  timerBadge: { flexDirection: 'row', alignItems: 'center', gap: 12, backgroundColor: theme.colors.surfaceMuted, paddingHorizontal: 16, paddingVertical: 8, borderRadius: 32, borderWidth: 2, borderBottomWidth: 4, borderColor: theme.colors.borderSubtle },
  timerText: { fontFamily: 'IBM Plex Mono', fontSize: 14, color: theme.colors.onSurface, width: 48, textAlign: 'center' },
  
  content: { paddingHorizontal: 24, paddingTop: 32, paddingBottom: 200 },
  heroImageContainer: { height: 200, width: '100%', borderRadius: 16, overflow: 'hidden', borderWidth: 2, borderBottomWidth: 6, borderColor: theme.colors.borderSubtle, marginBottom: 32, backgroundColor: theme.colors.surface },
  heroImage: { width: '100%', height: '100%', opacity: 0.8 },
  heroOverlay: { position: 'absolute', bottom: 0, left: 0, right: 0, padding: 16 },
  heroTag: { fontFamily: 'JetBrainsMono_500Medium', fontSize: 10, color: theme.colors.primary, letterSpacing: 2 },
  
  tableHeader: { flexDirection: 'row', borderBottomWidth: 2, borderColor: theme.colors.borderSubtle, paddingBottom: 8, marginBottom: 16, paddingHorizontal: 16 },
  th: { fontFamily: 'JetBrainsMono_500Medium', fontSize: 12, color: theme.colors.onSurfaceVariant, letterSpacing: 1 },
  
  // Set Rows
  setDetailsGrid: { flex: 1, flexDirection: 'row', alignItems: 'center', marginLeft: 24 },
  prevCol: { flex: 1, justifyContent: 'center' },
  prevValText: { fontFamily: 'IBM Plex Mono', fontSize: 14, color: theme.colors.onSurfaceVariant },
  prevValSub: { fontFamily: 'Inter_400Regular', fontSize: 12, color: theme.colors.onSurfaceVariant },
  targetValSm: { fontFamily: 'JetBrainsMono_500Medium', fontSize: 12, color: theme.colors.onSurfaceVariant, marginTop: 4 },

  completedSetRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: theme.colors.surface, borderRadius: 16, padding: 16, borderWidth: 2, borderBottomWidth: 4, borderColor: theme.colors.borderSubtle },
  completedSetBadge: { width: 48, height: 48, borderRadius: 24, backgroundColor: theme.colors.surfaceMuted, alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: theme.colors.borderSubtle },
  completedSetNum: { fontFamily: 'Unbounded_500Medium', fontSize: 18, color: theme.colors.onSurfaceVariant },
  targetColCompleted: { flex: 2, flexDirection: 'row', justifyContent: 'flex-end', gap: 32, paddingRight: 16 },
  targetValLg: { fontFamily: 'IBM Plex Mono', fontSize: 20, color: theme.colors.onSurface },

  activeSetRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: theme.colors.surface, borderRadius: 16, padding: 24, borderWidth: 2, borderBottomWidth: 6, borderColor: theme.colors.primary },
  activeSetBadge: { width: 56, height: 56, borderRadius: 12, backgroundColor: theme.colors.primary, borderWidth: 2, borderBottomWidth: 4, borderColor: '#D88D22', alignItems: 'center', justifyContent: 'center' },
  activeSetNum: { fontFamily: 'Unbounded_500Medium', fontSize: 20, color: theme.colors.onPrimary },
  ...
  weightRepInput: { fontFamily: 'IBM Plex Mono', fontSize: 32, color: theme.colors.primary, textAlign: 'center', borderBottomWidth: 2, borderBottomColor: theme.colors.borderSubtle, minWidth: 64, paddingBottom: 4 },
  inputLabelActive: { fontFamily: 'JetBrainsMono_500Medium', fontSize: 12, color: theme.colors.primary, marginTop: 8, letterSpacing: 1 },
  inputDivider: { width: 1, height: 40, backgroundColor: theme.colors.borderSubtle },
  activeIndicator: { width: 32, height: 1, backgroundColor: theme.colors.primary, marginTop: 12 },

  upcomingSetRow: { flexDirection: 'row', alignItems: 'center', backgroundColor: theme.colors.surfaceMuted, borderRadius: 16, padding: 16, borderWidth: 2, borderBottomWidth: 4, borderColor: theme.colors.borderSubtle, borderStyle: 'dashed' },
  upcomingSetBadge: { width: 48, height: 48, borderRadius: 24, borderWidth: 2, borderColor: theme.colors.borderSubtle, alignItems: 'center', justifyContent: 'center' },
  upcomingSetNum: { fontFamily: 'Unbounded_500Medium', fontSize: 18, color: theme.colors.onSurfaceVariant },
  targetColUpcoming: { flex: 2, flexDirection: 'row', justifyContent: 'flex-end', gap: 32, paddingRight: 16 },
  targetValUpcomingLg: { fontFamily: 'IBM Plex Mono', fontSize: 20, color: theme.colors.onSurfaceVariant },

  // FABs
  fabContainer: { position: 'absolute', bottom: 130, right: 24, zIndex: 50, alignItems: 'center' },
  restFab: { width: 56, height: 56, marginBottom: 16, backgroundColor: theme.colors.surfaceMuted, borderWidth: 2, borderBottomWidth: 4, borderColor: theme.colors.borderSubtle, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
  restFabText: { fontFamily: 'JetBrainsMono_500Medium', fontSize: 8, color: theme.colors.onSurfaceVariant, letterSpacing: 0.5, marginTop: 2 },
  completeFab: { width: 80, height: 80, backgroundColor: theme.colors.primary, borderRadius: 24, borderWidth: 2, borderBottomWidth: 8, borderColor: '#D88D22', alignItems: 'center', justifyContent: 'center' },

  // Footer
  footer: { position: 'absolute', bottom: 0, left: 0, right: 0, height: 112, backgroundColor: theme.colors.surface, borderTopWidth: 2, borderColor: theme.colors.borderSubtle, zIndex: 40, paddingHorizontal: 24, paddingVertical: 12 },
  footerTitle: { fontFamily: 'JetBrainsMono_500Medium', fontSize: 12, color: theme.colors.onSurfaceVariant, letterSpacing: 1 },
  footerSub: { fontFamily: 'JetBrainsMono_500Medium', fontSize: 12, color: theme.colors.onSurfaceVariant },
  upcomingThumbnailRow: { width: 192, height: 56, backgroundColor: theme.colors.surfaceMuted, borderRadius: 12, borderWidth: 2, borderBottomWidth: 4, borderColor: theme.colors.borderSubtle, padding: 8, flexDirection: 'row', alignItems: 'center', gap: 12 },
  thumbPlaceholder: { width: 40, height: 40, borderRadius: 4, backgroundColor: theme.colors.surface, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  thumbTitle: { fontFamily: 'Inter_400Regular', fontSize: 14, color: theme.colors.onSurface, maxWidth: 100 },
  thumbSub: { fontFamily: 'IBM Plex Mono', fontSize: 12, color: theme.colors.onSurfaceVariant },
  addExerciseThumb: { width: 56, height: 56, backgroundColor: theme.colors.surfaceMuted, borderRadius: 12, borderWidth: 2, borderBottomWidth: 4, borderColor: theme.colors.borderSubtle, borderStyle: 'dashed', alignItems: 'center', justifyContent: 'center' }
});
